module.exports = function privacyPolicy(lastUpdated, companyName, url) {
  return [
    {
      text: `Last updated: ​${lastUpdated}`
    },
    {
      text: `${companyName} ("us", "we", or "our") operates ​
	${url} (the "Site"). This page informs you of our policies
	regarding the collection, use and disclosure of Personal Information we
	receive from users of the Site.`
    },
    {
      text: `We use your Personal Information only for providing and improving the
	Site. By using the Site, you agree to the collection and use of
	information in accordance with this policy.`
    },
    {
      heading: `Information Collection And Use`,
      text: `While using our Site, we may ask you to provide us with certain
    ...
    {
      heading: `Log Data`,
      text: `Like many site operators, we collect information that your browser sends
    ...
    },
    {
      ...
      text: `We may use your Personal Information to contact you with newsletters,
	marketing or promotional materials`
    },
    {
      heading: `Cookies`,
      text: `Cookies are files with small amount of data, which may include an
    ...
    {
      heading: "Security",
      text: `The security of your Personal Information is important to us, but
    ...
    },
    {
      ...
      text: `This Privacy Policy is effective as of ​${lastUpdated}​ and will remain in
